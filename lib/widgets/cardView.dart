          ...
          for (var index = 0; index < elementList.length; index++) {
            ...
            if (stateTypes == true) {
              if (typesOthernonmetals == true &&
                  ...
                  typesMetalloids == true && elementList[index]['type'] == 'metalloid' ||
                  ...
                  typesLanthanoids == true && elementList[index]['type'] == 'lanthanoid' ||
                  typesActinoids == true && elementList[index]['type'] == 'actinoid' ||
                  typesUnknown == true && elementList[index]['type'] == 'unknown') {
              } else {
                passed = false;
              }
            }
            ...
            if (stateConstructors == true) {
              if (constructorsProtonMin <= int.parse(elementList[index]['chargedComponent']) &&
                  constructorsProtonMax >= int.parse(elementList[index]['chargedComponent']) &&
                  constructorsElectronMin <= int.parse(elementList[index]['chargedComponent']) &&
                  constructorsElectronMax >= int.parse(elementList[index]['chargedComponent']) &&
                  constructorsNeutronMin <= int.parse(elementList[index]['neutron']) &&
                  constructorsNeutronMax >= int.parse(elementList[index]['neutron'])) {
              } else {
                passed = false;
              }
            }
                ...
                new GestureDetector(
                  onTap: () {
                    ...
                    String discoveryText() {
                      if (elementList[index]["discovery"] ==
                          "ancient") {
                        return ' ' +
                            Capitalizate(AppLocalizations.of(context)
                                .translate("ancient"));
                        ...
                        if (elementList[index]["gamma"] == true) {
                          ...
                          list += Capitalizate(
                              AppLocalizations.of(context)
                                  .translate("beta")) +
                              " ";
                        } else if (elementList[index]["alpha"] ==
                            true) {
                          list += Capitalizate(
                              AppLocalizations.of(context)
                                  .translate("alpha")) +
                                                      ...
                                                      child: Text(
                                                        ...
                                                        TextStyle(
                                                          ...
                                                          fontSize: MediaQuery.of(
                                                              ...
                                                              (1 /
                                                                  int.parse(
                                                                      AppLocalizations.of(context).translate("maxVolume"))),
                                                        ),
                                                      ),
                                                    ),
                                                    Tooltip(
